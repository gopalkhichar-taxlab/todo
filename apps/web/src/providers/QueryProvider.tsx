...
export function QueryProvider({ children }: QueryProviderProps) {
  // Create the QueryClient once per component lifecycle. Using useState
  // ensures each server render gets a fresh client while the browser re-uses
  // the same instance across navigations.
